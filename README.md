...
* `GridView` 实现功能列表
* `RecyclerView` 实现信息加载、刷新，含空数据提示
* `GreenDao` 数据库管理
* 多语言设计（Demo中只包含中英文，可自由增加其它语言）
* 动态权限管理
* 多种类型的 `Toast` 提示
* 可完全自定义的日历，可以实现各种变态需求
* 全 `.xml` 矢量图标
* 预置可动态添加的测试数据
## Demo展示
### 静态页面
<img src="/demoImg/home.png" alt="page home" width="40%"> <img src="/demoImg/me.png" alt="page me" width="40%">  
<img src="/demoImg/pick-up.png" alt="page pick-up" width="40%"> <img src="/demoImg/dietary.png" alt="page dietary" width="40%">
### 动态展示
GIF压缩会有色差，颜色搭配以静态截图为准  
